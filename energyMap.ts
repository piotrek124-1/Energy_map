...
let svg = d3.select("svg"), width = window.innerWidth, height = window.innerHeight

let projection = d3.geoNaturalEarth1().scale(width / 5.8).translate([width / 2.5, height / 2.1]);
